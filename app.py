...
def load_keras_model():
    try:
        ...
        st.error(f"❌ CRITICAL ERROR: No se pudo cargar 'keras_model.h5': {e}")
        return None
...
if img_file_buffer is not None and model is not None:
    # Procesamiento de la imagen para Keras / Teachable Machine
    ...
    with col1:
        ...
        # Barra de progreso para visualización futurista
    ...
    with col2:
        ...
        # Si tiene teléfono (0), audífonos (2), libro (3) o agua (4)
            ...
            st.markdown(
                ...
                <div class="alert-card">
                    ...
                    <p style="color: #ff80a0; font-size:16px;">
                        <strong>ACCESO DENEGADO:</strong> No puedes realizar la prueba. Debes retirar todos los objetos (teléfono, libro, termo o audífonos) de tu campo visual antes de continuar.
                    </p>
                </div>
            """,
                unsafe_allow_html=True,
    ...
    st.error("No se detectó el archivo 'keras_model.h5' en el repositorio.")
